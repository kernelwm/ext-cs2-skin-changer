...
int main()
{
    ...
    */
        ...
        // Auto Save Periodically? Or just rely on manually saving?
        // User asked: "save the config so when we restart the app, we dont have to choose all the skins again"
        // Let's simple AutoSave() every time a change happens (ShouldUpdate is true)
        if (ShouldUpdate) {
